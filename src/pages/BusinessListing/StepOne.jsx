            ...
            <div key={step} className="flex flex-col items-center text-center flex-1">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold ${
                  step === 1 ? "bg-yellow-500 text-white" : "bg-gray-200 text-gray-700"
                }`}
              >
                {step}
              </div>
        ...
        <form className="space-y-6" onSubmit={handleNext}>
          ...
          <div>
            ...
            <label className="mt-2 flex items-center space-x-2 text-sm text-gray-600">
              <input
                type="checkbox"
                checked={formData.isCACRegistered || false}
                onChange={(e) =>
                  setFormData((prev) => ({ ...prev, isCACRegistered: e.target.checked }))
                }
              />
          ...
          <div>
            ...
            <label className="mt-2 flex items-center space-x-2 text-sm text-gray-600">
              <input
                type="checkbox"
                checked={formData.hasBranches || false}
                onChange={(e) =>
                  setFormData((prev) => ({ ...prev, hasBranches: e.target.checked }))
                }
              />
