          ...
          >
            ...
            <div className="md:w-2/3 border-r border-gray-300 pr-6">
              ...
              <div className="flex justify-between items-center flex-wrap gap-4 mt-8">
                ...
                <button className="inline-flex items-center gap-2 px-4 py-2 border border-black text-black rounded-full text-sm font-medium hover:bg-black hover:text-customGold transition group whitespace-nowrap">
                  Explore more
                  <svg
